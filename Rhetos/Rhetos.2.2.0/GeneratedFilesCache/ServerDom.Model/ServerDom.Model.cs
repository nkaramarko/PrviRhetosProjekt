...
namespace Common
{
    ...
    public class Principal : EntityBase<Common.Principal>, Rhetos.Dom.DefaultConcepts.IPrincipal/*Next DataStructureInfo ClassInterace Common.Principal*/
    {
        ...
        public Common.Queryable.Common_Principal ToNavigation()
        {
            ...
            return new Common.Queryable.Common_Principal
            {
                ID = item.ID,
                Name = item.Name,
                AspNetUserId = item.AspNetUserId/*DataStructureInfo AssignSimpleProperty Common.Principal*/
            };
        }

        [DataMember]/*PropertyInfo Attribute Common.Principal.Name*/
        public string Name { get; set; }
        [DataMember]/*PropertyInfo Attribute Common.Principal.AspNetUserId*/
    ...
    [DataContract]/*DataStructureInfo ClassAttributes Common.Permission*/
    public class Permission : EntityBase<Common.Permission>/*Next DataStructureInfo ClassInterace Common.Permission*/
    {
        /// <summary>Converts the simple object to a navigation object, and copies its simple properties. Navigation properties are set to null.</summary>
        public Common.Queryable.Common_Permission ToNavigation()
        {
            var item = this;
            return new Common.Queryable.Common_Permission
            {
                ID = item.ID,
                RoleID = item.RoleID,
                ClaimID = item.ClaimID,
                IsAuthorized = item.IsAuthorized/*DataStructureInfo AssignSimpleProperty Common.Permission*/
            };
        }

        [DataMember]/*PropertyInfo Attribute Common.Permission.RoleID*/
        public Guid? RoleID { get; set; }
        [DataMember]/*PropertyInfo Attribute Common.Permission.ClaimID*/
        public Guid? ClaimID { get; set; }
        [DataMember]/*PropertyInfo Attribute Common.Permission.IsAuthorized*/
        public bool? IsAuthorized { get; set; }
        /*DataStructureInfo ClassBody Common.Permission*/
    }

    [DataContract]/*DataStructureInfo ClassAttributes Common.AspNetFormsAuthPasswordAttemptsLimit*/
    public class AspNetFormsAuthPasswordAttemptsLimit : EntityBase<Common.AspNetFormsAuthPasswordAttemptsLimit>, Rhetos.AspNetFormsAuth.IPasswordAttemptsLimit/*Next DataStructureInfo ClassInterace Common.AspNetFormsAuthPasswordAttemptsLimit*/
    {
        /// <summary>Converts the simple object to a navigation object, and copies its simple properties. Navigation properties are set to null.</summary>
        public Common.Queryable.Common_AspNetFormsAuthPasswordAttemptsLimit ToNavigation()
        {
            var item = this;
            return new Common.Queryable.Common_AspNetFormsAuthPasswordAttemptsLimit
            {
                ID = item.ID,
                MaxInvalidPasswordAttempts = item.MaxInvalidPasswordAttempts,
                TimeoutInSeconds = item.TimeoutInSeconds/*DataStructureInfo AssignSimpleProperty Common.AspNetFormsAuthPasswordAttemptsLimit*/
            };
        }

        [DataMember]/*PropertyInfo Attribute Common.AspNetFormsAuthPasswordAttemptsLimit.MaxInvalidPasswordAttempts*/
        public int? MaxInvalidPasswordAttempts { get; set; }
        [DataMember]/*PropertyInfo Attribute Common.AspNetFormsAuthPasswordAttemptsLimit.TimeoutInSeconds*/
        public int? TimeoutInSeconds { get; set; }
        /*DataStructureInfo ClassBody Common.AspNetFormsAuthPasswordAttemptsLimit*/
    }

    [DataContract]/*DataStructureInfo ClassAttributes Common.AspNetFormsAuthPasswordStrength*/
    public class AspNetFormsAuthPasswordStrength : EntityBase<Common.AspNetFormsAuthPasswordStrength>, Rhetos.AspNetFormsAuth.IPasswordStrength/*Next DataStructureInfo ClassInterace Common.AspNetFormsAuthPasswordStrength*/
    {
        /// <summary>Converts the simple object to a navigation object, and copies its simple properties. Navigation properties are set to null.</summary>
        public Common.Queryable.Common_AspNetFormsAuthPasswordStrength ToNavigation()
        {
            var item = this;
            return new Common.Queryable.Common_AspNetFormsAuthPasswordStrength
            {
                ID = item.ID,
                RegularExpression = item.RegularExpression,
                RuleDescription = item.RuleDescription/*DataStructureInfo AssignSimpleProperty Common.AspNetFormsAuthPasswordStrength*/
            };
        }

        [DataMember]/*PropertyInfo Attribute Common.AspNetFormsAuthPasswordStrength.RegularExpression*/
        public string RegularExpression { get; set; }
        [DataMember]/*PropertyInfo Attribute Common.AspNetFormsAuthPasswordStrength.RuleDescription*/
        public string RuleDescription { get; set; }
        /*DataStructureInfo ClassBody Common.AspNetFormsAuthPasswordStrength*/
    }
    ...
    [DataContract]/*DataStructureInfo ClassAttributes Common.SystemRequiredAspNetUserId*/
    public class SystemRequiredAspNetUserId/*DataStructureInfo ClassInterace Common.SystemRequiredAspNetUserId*/
    {
        /*DataStructureInfo ClassBody Common.SystemRequiredAspNetUserId*/
    }

    [DataContract]/*DataStructureInfo ClassAttributes Common.SystemRequiredMaxInvalidPasswordAttempts*/
    public class SystemRequiredMaxInvalidPasswordAttempts/*DataStructureInfo ClassInterace Common.SystemRequiredMaxInvalidPasswordAttempts*/
    {
        /*DataStructureInfo ClassBody Common.SystemRequiredMaxInvalidPasswordAttempts*/
    }
...
namespace Common.Queryable
{
    ...
    /*DataStructureInfo QueryableClassAttributes Common.Permission*/
    public class Common_Permission : global::Common.Permission, IQueryableEntity<Common.Permission>, System.IEquatable<Common_Permission>, IDetachOverride/*DataStructureInfo QueryableClassInterace Common.Permission*/
    {
        bool IDetachOverride.Detaching { get; set; }

        /// <summary>Converts the object with navigation properties to a simple object with primitive properties.</summary>
        public Common.Permission ToSimple()
        {
            var item = this;
            return new Common.Permission
            {
                ID = item.ID,
                RoleID = item.RoleID,
                ClaimID = item.ClaimID,
        ...
        /*DataStructureQueryable PropertyAttribute Common.Permission.Role*/
        public virtual Common.Queryable.Common_Role Role
        {
            get
            {
                /*DataStructureQueryable Getter Common.Permission.Role*/
                return _role;
            }
            set
            {
                if (((IDetachOverride)this).Detaching) return;
                /*DataStructureQueryable Setter Common.Permission.Role*/
                _role = value;
                RoleID = value != null ? (Guid?)value.ID : null;
            }
        }
        ...
        /*DataStructureQueryable PropertyAttribute Common.Permission.Claim*/
        public virtual Common.Queryable.Common_Claim Claim
        {
            get
            {
                /*DataStructureQueryable Getter Common.Permission.Claim*/
                return _claim;
            }
            set
            {
                if (((IDetachOverride)this).Detaching) return;
                /*DataStructureQueryable Setter Common.Permission.Claim*/
                _claim = value;
                ClaimID = value != null ? (Guid?)value.ID : null;
            }
        }

        /*DataStructureInfo QueryableClassMembers Common.Permission*/

        public bool Equals(Common_Permission other)
        {
            return other != null && other.ID == ID;
        }
    }

    /*DataStructureInfo QueryableClassAttributes Common.AspNetFormsAuthPasswordAttemptsLimit*/
    public class Common_AspNetFormsAuthPasswordAttemptsLimit : global::Common.AspNetFormsAuthPasswordAttemptsLimit, IQueryableEntity<Common.AspNetFormsAuthPasswordAttemptsLimit>, System.IEquatable<Common_AspNetFormsAuthPasswordAttemptsLimit>, IDetachOverride/*DataStructureInfo QueryableClassInterace Common.AspNetFormsAuthPasswordAttemptsLimit*/
    {
        bool IDetachOverride.Detaching { get; set; }

        /// <summary>Converts the object with navigation properties to a simple object with primitive properties.</summary>
        public Common.AspNetFormsAuthPasswordAttemptsLimit ToSimple()
        {
            var item = this;
            return new Common.AspNetFormsAuthPasswordAttemptsLimit
            {
                ID = item.ID,
                MaxInvalidPasswordAttempts = item.MaxInvalidPasswordAttempts,
                TimeoutInSeconds = item.TimeoutInSeconds/*DataStructureInfo AssignSimpleProperty Common.AspNetFormsAuthPasswordAttemptsLimit*/
        ...
        /*DataStructureInfo QueryableClassMembers Common.AspNetFormsAuthPasswordAttemptsLimit*/

        public bool Equals(Common_AspNetFormsAuthPasswordAttemptsLimit other)
        {
            return other != null && other.ID == ID;
        }
    }

    /*DataStructureInfo QueryableClassAttributes Common.AspNetFormsAuthPasswordStrength*/
    public class Common_AspNetFormsAuthPasswordStrength : global::Common.AspNetFormsAuthPasswordStrength, IQueryableEntity<Common.AspNetFormsAuthPasswordStrength>, System.IEquatable<Common_AspNetFormsAuthPasswordStrength>, IDetachOverride/*DataStructureInfo QueryableClassInterace Common.AspNetFormsAuthPasswordStrength*/
    {
        bool IDetachOverride.Detaching { get; set; }

        /// <summary>Converts the object with navigation properties to a simple object with primitive properties.</summary>
        public Common.AspNetFormsAuthPasswordStrength ToSimple()
        {
            var item = this;
            return new Common.AspNetFormsAuthPasswordStrength
            {
                ID = item.ID,
                RegularExpression = item.RegularExpression,
                RuleDescription = item.RuleDescription/*DataStructureInfo AssignSimpleProperty Common.AspNetFormsAuthPasswordStrength*/
        ...
        /*DataStructureInfo QueryableClassMembers Common.AspNetFormsAuthPasswordStrength*/

        public bool Equals(Common_AspNetFormsAuthPasswordStrength other)
        {
            return other != null && other.ID == ID;
        }
    }
...
namespace Rhetos.Dom.DefaultConcepts
{
    ...
    public static class QueryExtensions
    {
        ...
        /// <summary>Converts the objects with navigation properties to simple objects with primitive properties.</summary>
        public static IQueryable<Common.Permission> ToSimple(this IQueryable<Common.Queryable.Common_Permission> query)
        {
            return query.Select(item => new Common.Permission
            {
                ID = item.ID,
                RoleID = item.RoleID,
                ClaimID = item.ClaimID,
        ...
        /// <summary>Converts the objects with navigation properties to simple objects with primitive properties.</summary>
        public static IQueryable<Common.AspNetFormsAuthPasswordAttemptsLimit> ToSimple(this IQueryable<Common.Queryable.Common_AspNetFormsAuthPasswordAttemptsLimit> query)
        {
            return query.Select(item => new Common.AspNetFormsAuthPasswordAttemptsLimit
            {
                ID = item.ID,
                MaxInvalidPasswordAttempts = item.MaxInvalidPasswordAttempts,
                TimeoutInSeconds = item.TimeoutInSeconds/*DataStructureInfo AssignSimpleProperty Common.AspNetFormsAuthPasswordAttemptsLimit*/
        ...
        /// <summary>Converts the objects with navigation properties to simple objects with primitive properties.</summary>
        public static IQueryable<Common.AspNetFormsAuthPasswordStrength> ToSimple(this IQueryable<Common.Queryable.Common_AspNetFormsAuthPasswordStrength> query)
        {
            return query.Select(item => new Common.AspNetFormsAuthPasswordStrength
            {
                ID = item.ID,
                RegularExpression = item.RegularExpression,
                RuleDescription = item.RuleDescription/*DataStructureInfo AssignSimpleProperty Common.AspNetFormsAuthPasswordStrength*/
