...
namespace Rhetos.Mvc.Common
{
    ...
    public partial class Principal : Rhetos.Mvc.BaseMvcModel
    {
        ...
        [Display(Name = "Common_Principal_AspNetUserId", ResourceType = typeof(CaptionsResourceClass), AutoGenerateFilter = true)]
        public virtual int? AspNetUserId { get; set; }
        public const string PropertyAspNetUserId = "AspNetUserId";
    }
}
...
namespace Rhetos.Mvc.Common
{
    [Rhetos.Mvc.LocalizedDisplayName("Common_Permission", typeof(CaptionsResourceClass))]
    [Rhetos.Mvc.ReadableDataStructure]
    [Rhetos.Mvc.WritableDataStructure]
    public partial class Permission : Rhetos.Mvc.BaseMvcModel
    {
        public const string EntityPermission = "Permission";

        [Display(Name = "Common_Permission_Role", ResourceType = typeof(CaptionsResourceClass), AutoGenerateFilter = true)]
        [Required()]
        public virtual Guid? RoleID { get; set; }
        public const string PropertyRoleID = "RoleID";
        
        [Display(Name = "Common_Permission_Claim", ResourceType = typeof(CaptionsResourceClass), AutoGenerateFilter = true)]
        [Required()]
        public virtual Guid? ClaimID { get; set; }
        public const string PropertyClaimID = "ClaimID";
        
        [Display(Name = "Common_Permission_IsAuthorized", ResourceType = typeof(CaptionsResourceClass), AutoGenerateFilter = true)]
        [Required()]
        public virtual bool? IsAuthorized { get; set; }
        public const string PropertyIsAuthorized = "IsAuthorized";
    }
...
namespace Rhetos.Mvc.Common
{
    [Rhetos.Mvc.LocalizedDisplayName("Common_AspNetFormsAuthPasswordAttemptsLimit", typeof(CaptionsResourceClass))]
    [Rhetos.Mvc.ReadableDataStructure]
    [Rhetos.Mvc.WritableDataStructure]
    public partial class AspNetFormsAuthPasswordAttemptsLimit : Rhetos.Mvc.BaseMvcModel
    {
        public const string EntityAspNetFormsAuthPasswordAttemptsLimit = "AspNetFormsAuthPasswordAttemptsLimit";

        [Display(Name = "Common_AspNetFormsAuthPasswordAttemptsLimit_MaxInvalidPasswordAttempts", ResourceType = typeof(CaptionsResourceClass), AutoGenerateFilter = true)]
        [Required()]
        public virtual int? MaxInvalidPasswordAttempts { get; set; }
        public const string PropertyMaxInvalidPasswordAttempts = "MaxInvalidPasswordAttempts";
        
        [Display(Name = "Common_AspNetFormsAuthPasswordAttemptsLimit_TimeoutInSeconds", ResourceType = typeof(CaptionsResourceClass), AutoGenerateFilter = true)]
        public virtual int? TimeoutInSeconds { get; set; }
        public const string PropertyTimeoutInSeconds = "TimeoutInSeconds";
    }
}
...
namespace Rhetos.Mvc.Common
{
    [Rhetos.Mvc.LocalizedDisplayName("Common_AspNetFormsAuthPasswordStrength", typeof(CaptionsResourceClass))]
    [Rhetos.Mvc.ReadableDataStructure]
    [Rhetos.Mvc.WritableDataStructure]
    public partial class AspNetFormsAuthPasswordStrength : Rhetos.Mvc.BaseMvcModel
    {
        public const string EntityAspNetFormsAuthPasswordStrength = "AspNetFormsAuthPasswordStrength";

        [Display(Name = "Common_AspNetFormsAuthPasswordStrength_RegularExpression", ResourceType = typeof(CaptionsResourceClass), AutoGenerateFilter = true)]
        [MaxLength(256)]
        public virtual string RegularExpression { get; set; }
        public const string PropertyRegularExpression = "RegularExpression";
        
        [Display(Name = "Common_AspNetFormsAuthPasswordStrength_RuleDescription", ResourceType = typeof(CaptionsResourceClass), AutoGenerateFilter = true)]
        [MaxLength(256)]
        public virtual string RuleDescription { get; set; }
        public const string PropertyRuleDescription = "RuleDescription";
    }
}
...
namespace Rhetos.Mvc.Common
{
    [Rhetos.Mvc.LocalizedDisplayName("Common_SystemRequiredAspNetUserId", typeof(CaptionsResourceClass))]
    public partial class SystemRequiredAspNetUserId
    {
        public const string EntitySystemRequiredAspNetUserId = "SystemRequiredAspNetUserId";
    }
}
...
namespace Rhetos.Mvc.Common
{
    [Rhetos.Mvc.LocalizedDisplayName("Common_SystemRequiredMaxInvalidPasswordAttempts", typeof(CaptionsResourceClass))]
    public partial class SystemRequiredMaxInvalidPasswordAttempts
    {
        public const string EntitySystemRequiredMaxInvalidPasswordAttempts = "SystemRequiredMaxInvalidPasswordAttempts";
    }
}
